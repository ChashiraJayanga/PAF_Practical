...
public class feedbackAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 String output = feedbackObj.insertFeedback(request.getParameter("cusID"), 
				 request.getParameter("fbTitle"), 
				request.getParameter("fbRating"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
		 ...
		 paras.get("fbTitle").toString(), 
		 paras.get("fbRating").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 String output = feedbackObj.deleteFeedback(paras.get("fbID").toString()); 
